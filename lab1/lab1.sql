...
IF DB_ID('BD_COMERCIAL') IS NOT NULL --LA FUNCIONALIDAD DE LA SENTENCIA IF BD_ID... SE ESPECIFICA MÁS ABAJO (LINEA 204)
BEGIN
...
USE MASTER 
GO
ALTER DATABASE BD_TIENDA -- AQUÍ DEBES COLOCAR EL NOMBRE DE LA BASE DE DATOS A MODIFICAR
MODIFY NAME = MINIMARKET -- AQUÍ DEBES COLOCAR EL NOMBRE QUE LE ASIGNARAS
GO
...
--SI SE DA EL CASO DE QUE LA BD EXISTE, ESTA SERÁ ELIMINADA
